      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <p className="text-xs text-gray-500 mt-2">From paid and fulfilled orders</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <p className="text-xs text-gray-500 mt-2">Units paid or fulfilled</p>
          </div>
                  ...
                  {products.map((product) => {
                    ...
                    return (
                      <tr key={product.id} className="border-t">
                        ...
                        <td className="p-3">{matchingInventory?.quantity ?? 0}</td>
