  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const keycloak = new (window as any).Keycloak({
        ...
        realm: 'zammunda-security-realm',
        clientId: 'zammunda-web'
      });
      ...
      if (authenticated) {
        ...
        localStorage.setItem('keycloak-token', JSON.stringify(tokenData));
        
        // Store keycloak instance for later use
      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Use your Keycloak credentials to access the platform
          </p>
        </div>
