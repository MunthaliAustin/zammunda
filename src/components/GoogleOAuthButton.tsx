  ...
  return (
    <div className="w-full">
      <button
        ...
        disabled={isLoading}
        className="w-full py-3 px-4 rounded-full font-semibold text-gray-700 bg-white border-2 border-gray-300 hover:bg-gray-50 transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <svg
          className="w-5 h-5"
          viewBox="0 0 24 24"
