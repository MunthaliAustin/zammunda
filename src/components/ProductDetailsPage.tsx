          ...
          <div>
            ...
            <div className="prose max-w-none text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600">
                <li><strong>Category:</strong> {safeRender(product.category)}</li>
                <li><strong>Farm:</strong> {safeRender(product.farmName)}</li>
                <li><strong>Weight/Quantity:</strong> {safeRender(product.weight)}</li>
            ...
            {product.inStock && (
              <div className="mt-8 flex items-center space-x-4">
                ...
                <button 
                  ...
                  className="flex-1 bg-green-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-green-700 transform transition-all duration-300 hover:scale-105 shadow-lg"
                >
                  Add to Cart
                </button>
              </div>
